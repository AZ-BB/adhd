...
export default function CreateBlogForm({ onCreate }: CreateBlogFormProps) {
  ...
  useEffect(() => {
    setIsDisabled(title === "" || slug === "" || description === "" || content === "")
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        />
        <p className="mt-2 text-xs text-gray-400">You can use HTML tags for formatting</p>
      </div>
