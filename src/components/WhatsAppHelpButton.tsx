...
const WHATSAPP_NUMBER = '971564251027'
const WHATSAPP_MESSAGE = 'Hello! I need help with Movokids.'
  ...
  return (
    <Link
      ...
      className={`
        ...
        group
      `}
      aria-label={isEnglish ? 'Need help? Contact us on WhatsApp' : 'تحتاج مساعدة؟ تواصل معنا على واتساب'}
    >
      {/* WhatsApp Icon */}
      <svg
