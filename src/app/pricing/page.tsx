...
export default function PricingPage() {
  ...
  const packages = [
    ...
    },
    {
      id: 3,
      name: "الباقة الفردية",
      description: "الألعاب + جلسات فردية",
      icon: "👤",
      features: [
        "جميع الألعاب التعليمية",
        "جلسات فردية حسب الاختيار",
        "تتبع التقدم",
        "دعم فني متواصل"
      ],
      hasDropdown: true,
                ...
                <div className="text-center mb-6">
                  ...
                  {pkg.hasDropdown && (
                    <div className="mb-4">
                      ...
                      >
                        <option value={1}>1 جلسة فردية</option>
                        <option value={2}>2 جلسات فردية</option>
                        <option value={3}>3 جلسات فردية</option>
                        <option value={4}>4 جلسات فردية</option>
                      </select>
                    </div>
                  )}
                  ...
                  <div className="mb-2">
                    ...
                    <span className="text-xl text-sky-700 mr-2">
                      {pkg.hasDropdown 
                        ? (isEgypt ? "جنيه مصري" : "درهم إماراتي")
                        : pkg.currency}
                    </span>
                ...
                <ul className="space-y-3 mb-8">
                  {pkg.features.map((feature, idx) => (
                    <li key={idx} className="flex items-start gap-2 text-sky-800/80">
                      ...
                      <span>
                        {pkg.hasDropdown && feature === "جلسات فردية حسب الاختيار"
                          ? `${selectedSessions} ${selectedSessions === 1 ? "جلسة فردية" : "جلسات فردية"}`
                          : feature}
                      </span>
                    </li>
                  ))}
