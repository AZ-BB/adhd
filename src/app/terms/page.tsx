      ...
      <main className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white/90 rounded-3xl border border-sky-100 p-8 md:p-12 shadow-sm">
          ...
          <div className="prose prose-sky max-w-none text-right space-y-6 text-sky-900/80 leading-relaxed">
            <p className="text-lg">
              باستخدامك لمنصة Movokids فإنك توافق على ما يلي:
            </p>

            <section>
              <ul className="list-disc mr-6 space-y-3">
                <li className="text-base">
                  المنصة تعليمية تدريبية وليست بديلاً عن الاستشارات الطبية
                </li>
                <li className="text-base">
                  الاشتراك شخصي وغير قابل للمشاركة
                </li>
                <li className="text-base">
                  يمنع إساءة استخدام المنصة أو نسخ محتواها
                </li>
                <li className="text-base">
                  قد يتم تعديل الأسعار والسياسات عند الحاجة مع إخطار المستخدمين
                </li>
                <li className="text-base">
                  أي استخدام مخالف يعرّض الحساب للإيقاف
                </li>
              </ul>
            </section>
            ...
            <section>
              <div className="bg-sky-50 border-r-4 border-sky-400 p-6 mt-6 rounded-lg">
                <p className="text-base leading-relaxed font-semibold">
                  نلتزم بتقديم أفضل تجربة ممكنة لكم ولأطفالكم.
                </p>
              </div>
            </section>
          </div>
