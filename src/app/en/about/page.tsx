          ...
          <div className="prose prose-sky max-w-none space-y-6 text-sky-900/80 leading-relaxed">
            <section>
              <p className="text-lg mb-6">
                Movokids is a specialized educational and training platform for children, aimed at developing their focus, attention, cognitive and behavioral skills in a fun and safe way.
              </p>
              <p className="text-base mb-6">
                We offer a collection of daily interactive activities, short training games, and carefully designed exercises to help children improve their mental abilities, organize their behavior, and support their academic achievement.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc ml-6 space-y-3">
                <li className="text-base">
                  Help children increase focus and attention
                </li>
                <li className="text-base">
                  Reduce distraction and impulsivity
                </li>
                <li className="text-base">
                  Support parents with clear training plans
                </li>
                <li className="text-base">
                  Provide a fun and safe educational environment
                </li>
                <li className="text-base">
                  Build a daily habit of learning and training
                </li>
              </ul>
            </section>
            ...
            <section>
              <div className="bg-sky-50 border-l-4 border-sky-400 p-6 mt-6 rounded-lg">
                <p className="text-base leading-relaxed">
                  The Movokids team includes educational and technical specialists working together to provide a modern and effective educational experience that meets your child's needs.
                </p>
              </div>
            </section>
          </div>
