...
import ColorSwitchingGame from '@/components/games/ColorSwitchingGame'
...
export default function LearningDayClient({ dayDetails, userId }: LearningDayClientProps) {
      ...
      <div className="flex flex-col items-center justify-center min-h-[80vh]">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-2">
            You completed Day {day.day_number}!
          </p>
  ...
  return (
    <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-4">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-700">
              Progress: {completedGames.size}/{totalGames} games completed
            </span>
        ...
        <div className="mt-6 flex gap-2 overflow-x-auto pb-2">
          {games.map((game, index) => (
            ...
            >
              ...
              <div className="text-sm">{game.game.name}</div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        {!['memory', 'matching', 'sequence', 'attention', 'sorting', 'aiming', 'pattern', 'simon', 'reaction', 'colorswitch'].includes(currentGame?.game?.type || '') && (
          <div className="text-center py-12">
            <p className="text-gray-500 mb-4">
              {currentGame?.game?.name || ''} - {currentGame?.game?.type || ''}
            </p>
            <p className="text-sm text-gray-400">
              Game component not yet implemented
            </p>
            <button
      ...
      {currentGame?.attempts?.length > 0 && (
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-xl font-bold text-gray-800 mb-4">Previous Attempts</h3>
            ...
            {currentGame?.attempts?.map((attempt) => (
              ...
              >
                ...
                <div className="text-sm text-gray-600">
                  Score: {attempt.score} | Time: {attempt.time_taken_seconds}s
                </div>
              </div>
            ))}
          </div>
