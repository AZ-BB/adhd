...
/**
 * Upload an image to Supabase Storage for blogs
...
/**
 * Delete an image from Supabase Storage for blogs
 */
...
/**
 * Client-safe upload function that accepts FormData for blogs
 */
export async function uploadBlogImageFromFormData(
  formData: FormData
): Promise<{ url: string; path: string } | { error: string }> {
  try {
